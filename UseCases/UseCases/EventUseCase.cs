...
public class EventUseCase(IEventRepository _eventRepository, 
                            IImageUseCase _imageService, 
                            INotificationUseCase _notificationService,
                            IMemberUseCase _memberService,
                            IOptions<PaginationSettings> paginationOptions) : IEventUseCase
{
